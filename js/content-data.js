/**
 * Datos de contenido para funcionamiento sin servidor
 */

window.BOOK_CONTENT = {
    chapters: {
        1: {
            title: "Aprendí a andar en bicicleta",
            content: `"He aqui, mi Espíritu reposa sobre ti... anda conmigo" (Moises 6:34)
...
// Generar capítulos de demostración para el resto
for (let i = 3; i <= 32; i++) {
    window.BOOK_CONTENT.chapters[i] = {
        title: `Capítulo ${i}`,
        content: `# Capítulo ${i}

Este capítulo aún no está disponible en modo local.

**Para ver todo el contenido completo:**
...
4. Reinicia tu terminal/consola
5. Ejecuta: \`python server.py\`

¡Gracias por leer "Tesoros de Mi Alma"!`
    };
}